      ...
      <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
        ...
        <div className="p-6 flex flex-col justify-start">
          ...
          <div className="flex justify-between">
            <button onClick={() => navigateToInventoryDetail(_id)} type="button" className="w-48 inline-block px-6 py-2.5 bg-red-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-700 active:shadow-lg transition duration-150 ease-in-out">
              Item Details
            </button>
