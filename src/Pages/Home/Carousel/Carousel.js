    ...
    <div id="carouselExampleIndicators" className="carousel slide relative" data-bs-ride="carousel">
      ...
      <div className="carousel-inner relative w-full overflow-hidden">
        <div className="carousel-item active float-left w-full ">
          <img src="http://htmldemo.magikthemes.com/ecommerce/brezza-html-template/furniture/images/slide-img1.jpg" className="block w-full" alt="Wild Landscape" />
        </div>
        <div className="carousel-item float-left w-full">
          <img src="http://htmldemo.magikthemes.com/ecommerce/brezza-html-template/furniture/images/slide-img2.jpg" className="block w-full" alt="Camera" />
        </div>
      </div>
